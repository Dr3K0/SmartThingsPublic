...
definition(
    ...
    iconUrl: "http://icons.iconarchive.com/icons/icons-land/vista-hardware-devices/72/Security-Camera-icon.png",

    iconX2Url: "http://icons.iconarchive.com/icons/icons-land/vista-hardware-devices/96/Security-Camera-icon.png",

    iconX3Url: "http://icons.iconarchive.com/icons/icons-land/vista-hardware-devices/128/Security-Camera-icon.png",
